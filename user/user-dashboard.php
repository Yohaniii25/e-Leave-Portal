...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <!-- View Head Office Approved Leaves - Only for Head Office employees -->
            <?php if ($sub_office === 'Head Office'): ?>
                <a href="view_head_office_approved_leaves.php" class="bg-teal-600 hover:bg-teal-700 text-white rounded-lg p-6 transition-all duration-200 hover:shadow-lg group">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold mb-2">View Approved Leaves</h3>
                            <p class="opacity-90">All approved leave requests in Head Office</p>
                        </div>
                        <svg class="w-10 h-10 opacity-80 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php foreach ($leave_history as $leave): ?>
                            ...
                            $badge = $status === 'approved' ? 'bg-green-100 text-green-800' : ($status === 'rejected' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800');
                            $text  = ucfirst($status);
                            ?>
